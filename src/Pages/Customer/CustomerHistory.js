...
export default function CustomerHistory() {
  ...
  useEffect(() => {
    fetch(`http://localhost/WebApplication2/api/customer/customerhistory?c_id=${localStorage.getItem("c_id")}`, {
      method: "GET",
    })
                ...
                <div className='d-flex justify-content-between align-items-center p-3 border'>
                  <div className='d-flex'>
                    ...
                    <div className='ms-3'>
                      ...
                      <p className='card-text text-muted'>Order #{order.OrderNumber}</p>
                  ...
                  <div className='text-end'>
                    ...
                    <button
                      className={`btn ${order.Status === 'Cancelled' ? 'btn-secondary' : 'btn-danger'} mt-2`}
                      onClick={() => {
